...
public static class DesktopSidecarBridge
{
    ...
    public static void ConfigureRegistry(BridgeRegistryBuilder builder)
    {
        ...
        builder
            ...
            .RegisterCommand<ListChannelMembersRequest, ListChannelMembersResponse, ListChannelMembersHandler>(
                ...
                config => { config.SupportsCancellation = true; })
            .RegisterCommand<UpdateChannelMemberStatusRequest, UpdateChannelMemberStatusResponse, UpdateChannelMemberStatusHandler>(
    ...
    public static IReadOnlyList<BridgeNamedSchema> PayloadSchemas()
    {
        return new[]
        {
            ...
            Schema(DesktopSidecarProtocol.UpdateChannelMemberStatusCommand + ".request", UpdateChannelMemberStatusRequestSchema),
            Schema(DesktopSidecarProtocol.UpdateChannelMemberStatusCommand + ".response", UpdateChannelMemberStatusResponseSchema),
    ...
    private const string UpdateChannelMemberStatusRequestSchema = """
        {"type":"object","additionalProperties":false,"required":["channel_id","membership_id","membership_status"],"properties":{"channel_id":{"type":"integer"},"membership_id":{"type":"integer"},"membership_status":{"type":"string"}}}
        """;

    private const string UpdateChannelMemberStatusResponseSchema = """
        {"type":"object","additionalProperties":false,"required":["member"],"properties":{"member":{"type":"object","additionalProperties":false,"required":["id","member_type","member_identity","membership_status"],"properties":{"id":{"type":"integer"},"member_type":{"type":"string"},"member_identity":{"type":"string"},"membership_status":{"type":"string"},"wake_policy":{"type":["string","null"]},"can_send":{"type":"boolean"},"can_react":{"type":"boolean"},"can_invite":{"type":"boolean"},"cooldown_seconds":{"type":"integer"},"max_auto_replies_per_window":{"type":"integer"},"settings_label":{"type":["string","null"]}}}}}
        """;
    ...
    private const string MessagesSnapshotResponseSchema = """
        {"type":"object","additionalProperties":true,"required":["snapshot_id","project_id","generated_at","messages","unread_count","total_count","freshness"],"properties":{"snapshot_id":{"type":"string"},"project_id":{"type":"string"},"task_id":{"type":["integer","null"]},"thread_id":{"type":["integer","null"]},"generated_at":{"type":"string"},"messages":{"type":"array","items":{"type":"object","additionalProperties":true,"required":["id","sender","content","content_summary"],"properties":{"id":{"type":"integer"},"sender":{"type":"string"},"content":{"type":"string"},"intent":{"type":["string","null"]},"metadata_type":{"type":["string","null"]},"task_id":{"type":["integer","null"]},"thread_id":{"type":["integer","null"]},"created_at":{"type":["string","null"]},"is_unread":{"type":"boolean"},"content_summary":{"type":"string"}}}},"activity_events":{"type":"array","items":{"type":"object","additionalProperties":true,"required":["id","channel_id","agent_identity","event_type","status","sequence","title","summary"],"properties":{"id":{"type":"integer"},"channel_id":{"type":"integer"},"agent_identity":{"type":"string"},"delivery_request_id":{"type":["string","null"]},"hermes_session_key":{"type":["string","null"]},"task_id":{"type":["integer","null"]},"thread_id":{"type":["integer","null"]},"anchor_message_id":{"type":["integer","null"]},"event_type":{"type":"string"},"status":{"type":"string"},"sequence":{"type":"integer"},"update_version":{"type":"integer"},"title":{"type":"string"},"summary":{"type":"string"},"preview_json":{"type":["string","null"]},"metadata_json":{"type":["string","null"]},"created_at":{"type":["string","null"]},"updated_at":{"type":["string","null"]}}}},"thread_root":{"type":["object","null"]},"unread_count":{"type":"integer"},"total_count":{"type":"integer"},"freshness":{"type":"object","additionalProperties":false,"required":["source","is_partial","warnings","errors"],"properties":{"source":{"type":"string"},"generated_at":{"type":["string","null"]},"is_partial":{"type":"boolean"},"warnings":{"type":"array","items":{"type":"string"}},"errors":{"type":"array","items":{"type":"string"}}}}}}
        """;
